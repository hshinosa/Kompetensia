        ...
        <aside className="w-64 bg-white rounded-2xl border border-gray-200 h-fit sticky top-28 z-40 shadow-sm">
            <div className="p-6">
                ...
                <nav className="space-y-2">
                    ...
                    <Link
                        href="/client/pengaturan"
                        className={`flex items-center space-x-3 w-full text-left px-4 py-3 font-medium rounded-xl transition-colors ${
                            currentRoute === 'client.pengaturan'
                                ? 'bg-purple-700 text-white'
                                : 'text-gray-700 hover:bg-purple-50 hover:text-purple-700'
                        }`}
                    >
                    ...
                    <button
                        onClick={() => router.post('/client/logout')}
                        className="flex items-center space-x-3 w-full text-left px-4 py-3 text-red-600 hover:bg-red-50 rounded-xl transition-colors font-medium"
                    >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
