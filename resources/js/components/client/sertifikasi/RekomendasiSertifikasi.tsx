...
export default function RekomendasiSertifikasi({ rekomendasiSertifikasi }: Props) {
  ...
  return (
    <section id="recommend">
      <h3 className="text-xxl font-semibold mb-6">Rekomendasi Sertifikasi Lainnya</h3>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {displayList.map((item) => (
          <div key={item.id} className="border-2 border-purple-300 rounded-2xl overflow-hidden bg-white flex flex-col shadow-sm">
