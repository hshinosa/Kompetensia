...
export default function HeroSertifikasi({ sertifikasi, onScrollToBatch }: Props) {
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-0 h-full flex items-center">
        <div className="max-w-2xl text-white">
          ...
          <div className="mt-6 flex gap-3">
            <button onClick={() => onScrollToBatch?.()} className="px-4 py-2 rounded-md bg-purple-700 text-white font-semibold">Lihat Jadwal Batch</button>
