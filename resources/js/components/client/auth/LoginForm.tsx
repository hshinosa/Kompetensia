                ...
                <div className="p-8 lg:p-12 flex items-center justify-center">
                    <div className="w-full max-w-sm">
                        <div className="text-center mb-8">
                            <h1 className="text-4xl font-bold text-black mb-8">Masuk</h1>
                        </div>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g bagiajanur@gmail.com"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        placeholder="e.g MinIm@8 karakter"
                        ...
                        <div className="mt-6">
                            ...
                            <div className="text-center mt-6">
                                <span className="text-base text-gray-600">Belum memiliki akun? </span>
                                <Link 
